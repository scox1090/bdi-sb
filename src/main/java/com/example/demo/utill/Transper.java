...
public class Transper {
	...
	private static String clientId = "W7KO4G9pbYQ6pHn01Zi6";
	private static String clientSecret = "pg7jUQq3cP";
	...
	public static void main(String[] args) {
		...
		if (!Pattern.matches(regex, koStr)) {
			System.out.println("입력값은 반드시 한글이여야 합니다.");
			return;
		}
		if (koStr.trim().length() > 100) {
			System.out.println("글자수는 100글자를 넘을 수 없습니다.");
			return;
		}
		try {
